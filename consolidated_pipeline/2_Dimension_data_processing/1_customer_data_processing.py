...
base_path = f's3://sportsbar-gpm/{data_source}/*.csv'
print(base_path)
...
# MAGIC %md
# MAGIC 2: Trim spaces in customer names
...
# MAGIC %md
# MAGIC 4: Fixing title case issue
...
# MAGIC %md
# MAGIC 6: Convert Customer id to strings
...
# MAGIC %md
# MAGIC Merge the data source with parent 
